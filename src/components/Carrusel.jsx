...
export default function HeroCarousel() {
  return (
    ...
    >
      ...
      <button
        className="absolute left-6 top-1/2 -translate-y-1/2 z-30 bg-white/80 hover:bg-pink-600 hover:text-white text-pink-600 border-2 border-pink-600 shadow-lg rounded-full w-14 h-14 items-center justify-center transition-all duration-200 group hidden md:flex"
        style={{ fontSize: 32 }}
      ...
      <button
        className="absolute right-6 top-1/2 -translate-y-1/2 z-30 bg-white/80 hover:bg-pink-600 hover:text-white text-pink-600 border-2 border-pink-600 shadow-lg rounded-full w-14 h-14 items-center justify-center transition-all duration-200 group hidden md:flex"
        style={{ fontSize: 32 }}
