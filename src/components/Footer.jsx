      ...
      <div className="flex gap-6 justify-center mb-1">
        ...
        <a href="https://tiktok.com" target="_blank" rel="noopener noreferrer" aria-label="TikTok">
          <svg className="w-8 h-8 hover:scale-110 transition-transform" viewBox="0 0 48 48">
            ...
            <path d="M33.5 20.5c-2.2 0-4-1.8-4-4V13h-4v14.5a2.5 2.5 0 1 1-2.5-2.5c.6 0 1-.4 1-1s-.4-1-1-1A4.5 4.5 0 1 0 29.5 33V20.9c1.1.6 2.3.9 3.5.9.6 0 1-.4 1-1s-.4-1-1-1z" fill="#e6007e" fillOpacity=".7"/>
          </svg>
        </a>
      </div>
      <span>
